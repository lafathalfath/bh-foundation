...
@section('content')
    <main class="container mx-auto px-5 md:px-9">
        ...
        <section class="text-center py-10">
            ...
            @endif
            <h1 class="text-4xl font-bold mb-4">{{ translate($program->title, session('locale', 'en')) }}
            </h1>
            {{-- <p class="text-gray-600">Become an instructor & start teaching with 26k certified instructors. Create a
                success --}}
            ...
            <aside class="md:col-span-1">
                <div class="border rounded-lg p-4 shadow-md">
                    ...
                    <div class="flex items-center mb-4">
                        {{-- <img src="https://thumb.ac-illust.com/c1/c16bdfca25eca4c40e7e2b8f2bc9e4e4_t.jpeg"
                            alt="Author Image" class="rounded-full w-16 h-16 mr-3"> --}}
                        <div>
            ...
            <article class="md:col-span-2">
                <section class="mb-10">
                    ...
                    <p class="text-gray-800 mb-4">
                        {!! nl2br(e(translate($program->description, session('locale', 'en')))) !!}
                    </p>
                    {{-- <p class="text-gray-800 mb-4">
            ...
            <aside class="md:col-span-1">
                <div class="border rounded-lg p-4 shadow-md">
                    ...
                    <ul>
                        ...
                        <li class="mb-3">
                            <a href="https://www.instagram.com/bogorheritagefoundation"
        ...
        <section class="mt-20 mb-20">
            <h2 class="text-3xl font-bold mb-10 text-center">@lang('messages.related_post')</h2>
                        ...
                        'id' => Crypt::encryptString($rel->id)
                                ...
                                <div class="w-56 border rounded-lg overflow-hidden shadow-md flex flex-col items-center">
                                    <div class="w-full h-48 flex items-center justify-center">
                                        <img src="{{ $rel->image_url }}" alt="Related Post Image" class="w-full h-full object-cover">
                                    </div>
                                    <div class="w-full p-3">
                                        <h3 class="text-lg font-bold mb-2">
                                            {{ translate($rel->title, session('locale', 'en')) }}
                                        </h3>
                                        <p class="text-gray-600 text-sm mb-3">
                                            {{ $date }}
                                        </p>
                                        <div class="flex justify-end text-gray-500 text-sm">{{ $views }} @lang('messages.views')</div>
